...
def parse_args():
    ...
    parser.add_argument('src_path', type=str, required=True, help='Path to the source text file')
    parser.add_argument('tgt_path', type=str, required=True, help='Path to the target text file')
    parser.add_argument('output', type=str, required=True, help='Path to save the computed Fisher Information Matrix')
...
def main():
    ...
    dataset = MosesDataset(args.src_path, args.tgt_path, tokenizer)
